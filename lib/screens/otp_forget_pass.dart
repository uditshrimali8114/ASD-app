...
import 'package:asd/screens/newpass.dart';
...
class OTPForgetscreen extends StatefulWidget {
  const OTPForgetscreen({Key? key}) : super(key: key);

  @override
  _OTPForgetscreenState createState() => _OTPForgetscreenState();
}
...
class _OTPForgetscreenState extends State<OTPForgetscreen> {
  ...
  Future<void> submitOtp() async {
    Get.to(()=>NewPassword(), arguments: [otp,user]);
  }
