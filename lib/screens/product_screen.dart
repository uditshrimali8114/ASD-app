...
import 'package:asd/Api/scrollListener.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  void initState() {
    ...
    print('prevPageArgs'+prevPage.toString());
    isFollowed=prevPage[5].toString();
    sellerid = prevPage[0];
    name = prevPage[6];
    propic = prevPage[1];
    getData();
  ...
  List cartList = [];
  List SellerProducts = [];
  var isFollowed,sellerid,name,propic;
  var _pageSize;
  GetStorage box = GetStorage();
  var token,numItem,lastPage;
  bool loading = true;
  bool btmSheet = false;
  ...
  Future<void> getAllSellerProducts(token) async {

    // setState(() {
    //   SellerProducts= [];
    // });

    String url = ApiConfig().baseurl + ApiConfig().api_product_seller+_pageSize.toString()+"&seller_id="+sellerid.toString()+"&limit=5";
                ...
                children:[
                  ListTile(
                    ...
                    leading: Container(
                      ...
                      child:prevPage[1]==null? Image.asset('assets/images/profileimg.png',):Image.network(prevPage[1]),
                    ),
                    title: Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('${prevPage[2]}',style:const TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text("${prevPage[3]} Products",style:const TextStyle(fontSize: 16)),
                        Row(
                          children: [
                            RatingBar.builder(
                              initialRating: 3,
                              ...
                              itemBuilder: (context, _) => const Icon(
                                Icons.star,
                                color: const Color(0xFFc01211),
                              ),
                              onRatingUpdate: (rating) {
                                print(rating);
                              },
                            ),
                            Text("(${prevPage[4]})",style: const TextStyle(fontSize: 10),)
                          ],
                        )
                      ],
                    ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Get.to(()=>ChatDetails(),arguments: [sellerid,propic,name]);
                      ...
                      return Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            GestureDetector(
                              onTap: (){
                                Get.to(()=>const ProductDetails(), arguments: SellerProducts[index]['id']);
                              },
                              child: Container(
                                margin: const EdgeInsets.all(5),
                                // height: 120,s
                                height: height * 0.38,
                                child:SellerProducts[index]['product_images']==null?
                                Image.asset('assets/images/product01.png',
                                  alignment: Alignment.center,):
                                Image.network(SellerProducts[index]['product_images']),
                              ),
                            ),
                            Row(
                              ...
                              children: [
                                Container(
                                    margin: const EdgeInsets.fromLTRB(12, 7, 0, 10),
                                    child: Image.asset('assets/images/like.png')),
                                Container(
                                    margin: const EdgeInsets.fromLTRB(12, 7, 0, 10),
                                    child: Text("${SellerProducts[index]['total_likes']} Likes", style: const TextStyle(color: Color(0xffC1C1C1)),)),
                              ],
                            ),
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Container(
                                  width:width*0.6,
                                    margin: const EdgeInsets.fromLTRB(15, 7, 0, 5),
                                    child: Text(SellerProducts[index]['product_name'],maxLines: 1,overflow: TextOverflow.ellipsis,softWrap: false,
                                      style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),)),
                                Container(
                                    margin: const EdgeInsets.fromLTRB(12, 7, 12, 10),
                                    child: Text("\$${SellerProducts[index]['actual_price']}", style: const TextStyle(color: Color(0xff708090),fontSize: 16,decoration:TextDecoration.lineThrough),)
                                ),
                              ],
                            ),
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Container(
                                  ...
                                  child: Text("${SellerProducts[index]['description']}",maxLines: 1,overflow: TextOverflow.ellipsis,style:const TextStyle(color: const Color(0xff708090),fontSize: 16) ,),
                                ),
                                Container(
                                                        ...
                                                        Row(
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: ClipRRect(
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    child: Image.network(SellerProducts[index]['product_images'],
                                                                      fit: BoxFit.cover,),
                                                                  )
                                                              ),
                                                            ),
                                                            ...
                                                            Column(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  child: Text(SellerProducts[index]['product_name'],
                                                                    style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                                                                ),
                                                                SizedBox(height: 5,),
                                                                Container(
                                                                  width: size.width * 0.5,
                                                                  child: Text(SellerProducts[index]['description'], style: TextStyle(
                                                                      color: Colors.black,
                                                                      fontSize: 16,
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FlatButton(
                                                                      ...
                                                                      child : Text("\$${SellerProducts[index]['selling_price']}",style: const TextStyle(color: Colors.white),),
                                                                      shape: RoundedRectangleBorder(
                                                          ...
                                                          children: [
                                                            GestureDetector(
                                                              onTap: (){
                                                                ...
                                                                // Get.to(()=>Cart());
                                                                BuyNow(SellerProducts[index]['id']);
                                                              },
                                                              child: Container(
                                                            ...
                                                            GestureDetector(
                                                              onTap: (){
                                                                AddToCart(SellerProducts[index]['id']);
                                                              },
                                                              child: Container(
                                                                  height: 40,
                                                                  width: width * 0.4,
